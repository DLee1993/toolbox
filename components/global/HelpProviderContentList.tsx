export const HelpProviderContentList = [
        ...
        guide: {
            points: [
                { text: "Select your type", subText: "(Measurements or Currency)" },
                {
                    ...
                    subText: "(mm-cm, celsius-kelvin, dollars-pounds)",
                },
    ...
    },
    {
        url: "/tools/timezones",
        description:
            "A timezone selector that enables users to view and select time across global regions. You can view the current time and timezone offset compared to your local time.",
        guide: {
            points: [{ text: "Select the timezone you want to view", subText: "" }],
        },
    },
];
