...
const SIDEBAR_WIDTH_ICON = "2.65rem";
            ...
            return (
                <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
                    <SheetContent
                        ...
                        data-mobile="true"
                        className="w-[--sidebar-width] bg-background px-0 pt-0 text-foreground [&>button]:hidden"
                        style={
                            {
